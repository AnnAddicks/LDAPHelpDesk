...
import com.addicks.helpdesk.web.AppUserController;
...
privileged aspect AppUserController_Roo_Controller {
    ...
    void AppUserController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("appUser_lastresetpassword_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
